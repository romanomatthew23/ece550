...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ecepathplanning' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/matthew/ros/ece550/install/${idir}'.  Ask the maintainer 'Matthew Romano <mmroman2@illinois.edu>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/matthew/ros/ece550/install/lib;/home/matthew/ros/ece550/devel/lib;/opt/ros/indigo/lib)
